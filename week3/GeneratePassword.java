...
// Create class GeneratePassword to generate a random and secure password  
public class GeneratePassword {  
    ...
    // create generateSecurePassword() method that finds the secure 10 digit password and returns it to the main() method  
